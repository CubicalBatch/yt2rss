...
class YouTubeDownloader:
    ...
    def download_video(self, video_info: Dict[str, Any], channel_name: str, 
                      sponsorblock_categories: List[str] = None, format_type: str = "video", 
                      quality: str = "max") -> bool:
            ...
            for ext in thumbnail_extensions:
                ...
                if thumbnail_path.exists():
                    if ext == '.webp':
                        ...
                        try:
                            self.logger.info(f"   🖼️  Converting WebP thumbnail to JPG...")
